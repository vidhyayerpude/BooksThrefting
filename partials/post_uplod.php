...
else
{
    ...
    else
    {
        ...
        else
        {
            ...
            $sql="INSERT INTO `postbook` (`b_name`, `b_isbn`, `b_auth`, `og_pr`, `ex_pr`, `descript`, `pic1`, `pic2`, `pic3`, `genr1`, `genr2`, `genr3`, `genr4`, `used`, `display`, `usenam`) VALUES('$bookname', '$isbn', '$auth', '$ogpirce', '$exprice', '$description', '$filedestination1', '$filedestination2', '$filedestination3', '$gener1', '$gener2', '$gener3', '$gener4', 'N', 'Y', '$usenam')";
